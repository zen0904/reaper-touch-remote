...
test("rotary drag keeps small touch movements precise and accelerates long throws", () => {
  ...
  assert.ok(rotaryDragValue(1, -20, "touch") < 1, "a Threshold at 0 dB can be pulled down");
  assert.ok(rotaryDragValue(0, 20, "touch") > 0, "a minimum rotary value can be pushed up");
});
